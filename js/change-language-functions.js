var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Eπίδομα Στέγασης σε Φοιτητές",
      pageTitle: "Eπίδομα Στέγασης σε Φοιτητές",
      infoTitle: "Πληροφορίες για την χορήγηση του Στεγαστικού Επιδόματος σε Φοιτητές",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε το Φοιτητικό Στεγαστικό Επίδομα ",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Housing Allowance for Students",
      pageTitle: "Housing Allowance for Students",
      infoTitle: "Information on the granting of the Student Housing Allowance",
      subTitle1: "This questionnaire can help you find out if you are eligible to receive the Student Housing Allowance",
